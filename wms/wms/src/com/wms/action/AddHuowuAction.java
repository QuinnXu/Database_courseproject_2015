 ...
 *
 */
public class AddHuowuAction extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AddHuowuAction() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "insert into huowu values('" + bianhao + "','" + mingcheng
				+ "','"+leibie+"','" + guige + "','"+jiliang+"','"+zuigao+"','"+zuidi+"','"+beizhu+"')";
		...
		AddLog.addLog(request.getSession().getAttribute("user").toString(), "添加货物");
