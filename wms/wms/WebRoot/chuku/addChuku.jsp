...
-->
	...
	<body>
		...
		<form action="ChukuAction" method="post">
			<table width="43%" border="0" align="center" cellspacing="1"
				...
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<input name="chukushijian" type="text" id="chukushijian" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"   class="Wdate">
					</td>
				</tr>
				...
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<input name="chukudanjian" type="text" id="chukudanjian">
					</td>
				</tr>
				...
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<input id="chukushuliang" name="chukushuliang" type="text" />
				...
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<input id="kehu" name="kehu" type="text" />
