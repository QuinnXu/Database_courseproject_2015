...
<script language="javascript" type="text/javascript"
	...
	<body leftmargin="8" topmargin="8"'>
			...
			<div id="printTable">
				<table width="98%" border="0" cellpadding="2" cellspacing="1"
					...
					<%
						...
						String sql = "select * from ruku p  where 1=1";
					...
					<tr align='center' bgcolor="#FFFFFF"
						...
						<td>
							<%=rs.getString("rukushijian")%>
						</td>
						<td>
							<%=rs.getString("rukudanjia")%>
						</td>
						<td>
							<%=rs.getString("rukushuliang")%>
						</td>
					...
					<tr bgcolor="#FAFAF1">
						<td height="28" colspan="12">
							...
							<input type="button" onClick="doPrint();" border="0" class="np"
								value='打印' />
							&nbsp;&nbsp;
							<a href="ruku/addRuku.jsp"><strong>入库</strong> </a>
						</td>
		...
		<!--  搜索表单  -->
		<form action="ruku/list.jsp" method="post">
