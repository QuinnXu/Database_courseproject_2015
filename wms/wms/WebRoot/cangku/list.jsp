...
<script language="javascript" type="text/javascript"
	...
	<body leftmargin="8" topmargin="8"'>
			...
			<div id="printTable">
				<table width="98%" border="0" cellpadding="2" cellspacing="1"
					...
					<%
						...
						String sql = "select * from cangku p  where 1=1";
					...
					<tr align='center' bgcolor="#FFFFFF"
						...
						<td>
							<a href="cangku/modCangku.jsp?id=<%=id%>">编辑</a> |
							<a href="DelCangkuAction?id=<%=id%>">删除</a>
						</td>
					</tr>
					...
					<tr bgcolor="#FAFAF1">
						<td height="28" colspan="10">
							...
							<input type="button" onClick="doPrint();" border="0" class="np"
								value='打印' />
							&nbsp;&nbsp;
							<a href="cangku/addCangku.jsp"><strong>添加仓库</strong> </a>
						</td>
		...
		<!--  搜索表单  -->
		<form action="cangku/list.jsp" method="post">
